...
<div class="modal-content">
  ...
  <div class="modal-body">
    <div class="container d-flex flex-column gap-4 align-items-center justify-content-center">
      <h1>Create Animal Categorie</h1>
      <p>Choose image</p>
      <div class="input-group mb-3">
        <input type="file" class="form-control" id="inputGroupFile01" onchange="displaySelectedImage(event)" />
      </div>
      <div class="multi-img-container d-flex flex-wrap align-items-center justify-content-center gap-3 mb-3">
      </div>
  ...
  <div class="modal-footer justify-content-center">
    <button id="submitBtn" type="submit" class="btn" style="background-color: #a84e10" disabled>
...
<h2 style="color: #9eb77d" class="mb-3">Animal Categories</h2>
<div class="cards-container d-flex flex-wrap justify-content-center gap-5">
